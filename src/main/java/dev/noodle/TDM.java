...
public class TDM {
    ...
    // global "hooks" for gui extensions
    ...
    public static void main(String[] args) throws IOException {
        ...
        try {
            ...
            fileMenu.add(new MenuItem("Import New CSV File", new Runnable() {
                @Override
                public void run() {
                    try {
                        openFileDialog(finalSelectedFileLabel, globalGui);
    ...
    public static void openFileDialog( Label selectedFileLabels, MultiWindowTextGUI gui) throws SQLException, CsvValidationException, IOException, InterruptedException {
        String input = String.valueOf(new FileDialogBuilder()
                ...
                .setDescription("Choose a CSV file")
